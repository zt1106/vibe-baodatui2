...
pub const game_table = @import("game_table.zig");
pub const gouji_game = @import("gouji/game.zig");
...
test "all module tests are wired" {
    ...
    std.testing.refAllDecls(game_table);
    std.testing.refAllDecls(gouji_game);
